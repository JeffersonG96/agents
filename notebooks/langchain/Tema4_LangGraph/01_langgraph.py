...
#5. Conectar los nodos ensecuencia 
...
estado_inicial = {"texto_original": "Hola, desde pc de Jefferson"}
resultado = compile_graph.invoke(estado_inicial)
print(resultado)
